...
print('A uniform kernel:', ee.Kernel.square(2).getInfo())
...
print('A Gaussian kernel:', ee.Kernel.gaussian(2).getInfo())
...
print('Edge detection Laplacian kernel:', laplacianKernel.getInfo())
...
# Print the kernel to see its weights.
print('DoG kernel for image sharpening', dog.getInfo())
...
print('view the glcmTexture output', glcmTexture.getInfo())
