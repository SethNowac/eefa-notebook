...
var harmonicLandsatPre = harmonicLandsat.filterDate('2013-01-01',
    '2014-12-12');
...
var harmonicTrendCoefficientsPre = harmonicTrendPre.select(
        'coefficients')
    .arrayProject([0])
...
var harmonicLandsatDist = harmonicLandsat.filterDate('2014-12-13',
    '2019-01-01');
...
// Turn the array image into a multi-band image of coefficients.
var harmonicTrendCoefficientsDist = harmonicTrendDist.select(
        'coefficients')
    .arrayProject([0])
    .arrayFlatten([independents]);
