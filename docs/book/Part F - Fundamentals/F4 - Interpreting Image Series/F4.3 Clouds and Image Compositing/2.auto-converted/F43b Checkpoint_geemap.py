...
print('Size landsat8 collection', landsat8.size().getInfo())
print('Size landsat8FiltClouds collection', landsat8FiltClouds.size().getInfo())
...
print('Merged collections', landsat78.getInfo())
