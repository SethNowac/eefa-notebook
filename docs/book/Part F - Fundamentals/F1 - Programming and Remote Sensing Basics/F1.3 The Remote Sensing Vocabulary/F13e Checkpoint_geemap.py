...
print('MODIS NIR scale:', modisScale.getInfo())
...
print('TM NIR scale:', tmScale.getInfo())
...
.projection().nominalScale()
print('MSI scale:', msiScale.getInfo())
...
print('NAIP NIR scale:', naipScale.getInfo())
...
.filterBounds(Map.getCenter().getInfo()) \
...
# Print the chart.
print('TM Chart', tmChart.getInfo())
...
# Print the chart.
print('MSI Chart', msiChart.getInfo())
...
# Display the chart.
print(modisReflectanceChart.getInfo())
...
print('EO-1 bands:', eo1Bands.getInfo())
...
# Metadata
##/
print('MSI Image Metadata', msiImage.getInfo())

# Image-level Cloud info
msiCloudiness = msiImage.get('CLOUDY_PIXEL_PERCENTAGE')

print('MSI CLOUDY_PIXEL_PERCENTAGE:', msiCloudiness.getInfo())
