...
print(ndviElev, 'Multi band image'.getInfo())
...
print(aspenSites, 'Sites'.getInfo())
...
print(ndviRange, 'NDVI Range'.getInfo())
...
def func_cah(image, geom, pixelSize):
...
def func_nym(dictionary, key, proportion):
...
print(aspenSites2, 'aspenSites2'.getInfo())
