...
globalwater = ee.Image('JRC/GSW1_0/GlobalSurfaceWater'); 
...
occurrence = globalwater.select('occurrence'); 
...
features = stratified.map(func_pvd)
...
classifiedrf1 = composite.select(bands) \
.classify(RandomForest1); 

classifiedrf2 = composite.select(bands) \
...
print('Overall Accuracy Map 1: ', testAccuracy1.accuracy().getInfo())
print('Overall Accuracy Map 2: ', testAccuracy2.accuracy().getInfo())
print('Kappa: ', kappa1.getInfo())
print('Kappa: ', kappa2.getInfo())

print('Validation error matrix Map1: ', testAccuracy1.getInfo())
print('Validation error matrix Map2: ', testAccuracy2.getInfo())
