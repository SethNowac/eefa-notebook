...
completeCol = ee.ImageCollection("MODIS/061/MOD10A1") \
...
# Display it on the map. #ERROR HERE!!! REVISE
...
annualAoiMean = annualCol.select('calDoy').map(func_wql)
...
chart = ui_chart.feature_by_feature(annualAoiMean, 'year',
['calDoy'], kwargs=
{
