...
print('Baseline vs lockdown NO2 for the study region by DOY', chart1.getInfo())
...
no2Agg_forPlotting = no2Agg_popWeighted.map(func_yui
...
).merge(no2Agg_popWeighted.map(func_psg
...
# Print it to the console
print('Raw vs population-weighted NO2 for the study region', chart2.getInfo())
...
No2AggMulti_popWeighted = regions.map(func_zdr
