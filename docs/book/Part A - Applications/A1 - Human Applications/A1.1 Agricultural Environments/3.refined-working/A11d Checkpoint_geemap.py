...
def imageHarmonicRegr(harmonicColl, dependent, independents):
    ...
    newNames = independents.map(func_xao)
...
fittedHarmonic = landsatPlus.map(func_keg)
