...
print('ruralRefStd', ruralRefStd.getInfo())
...
print('reduced', reduced.getInfo())
print('reducedRural', reducedRural.getInfo())
print('reducedRuralStd', reducedRuralStd.getInfo())
