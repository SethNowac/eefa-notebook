...
print(postMedian, 'postMedian'.getInfo())
...
print(postIndicesChart.getInfo())
...
print(pagirinya, 'Pagirinya with population estimates'.getInfo())
...
print('Pagirinya Population Estimations', pagirinya.getInfo())
