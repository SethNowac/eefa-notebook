...
print('LSTStartDate', LSTStartDate.getInfo())
...
print('precipStartDate', precipStartDate.getInfo())
...
.min(reqStartDate.millis()))
print('brdfStartDate', brdfStartDate.getInfo())
print('brdfEndDate', brdfAllEndDate.getInfo())
...
print('precipEndDate ', precipEndDate.getInfo())
